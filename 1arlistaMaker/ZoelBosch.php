...
$path = 'y:\Árlista 2025\FELTÖLTÖTT ÁRLISTÁK 2025\U-Z\ZOEL\ZOEL-NET-prices-export-BOSCH-oct-20241003-M.xlsx';
$manufacturer = 'BOSCH';
...
for ($row = 2; $row <= $highestRow; $row++) {
    ...
    $price = $newSheet->getCell("F$row")->getValue();

    $newSheet->setCellValueExplicit("F$row", round($price, 2), DataType::TYPE_STRING);
}


function loadSizeData()
{
    $path = 'z:\szerző peti\BOSCH.csv';
