<pre><?php
        ...
        $beszalltioFilePath = 'y:\gerison_arlista\Cenik_se_stavy_SVATAVA.csv';
        ...
        if ($handle = fopen($beszalltioFilePath, 'r')) {
            ...
            if (file_put_contents('c:\Users\LP-GERGO\Desktop\jmautost_nalunkvan0_output_20250331.csv', $srt)) {
                echo "kiirás kész";
            }
